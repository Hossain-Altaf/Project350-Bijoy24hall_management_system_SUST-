...
document.querySelectorAll('.feature-card, .process-step, .notice-item').forEach(element => {
...
console.log('%c Welcome to Bijoy 24 Hall Management System! ', 
    'background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; font-size: 16px; padding: 10px; border-radius: 5px;');
console.log('%c Developed with ❤️ for efficient hall management', 
...
// Feature card click handler (for future functionality)
document.querySelectorAll('.feature-card').forEach(card => {
    card.addEventListener('click', function() {
        const featureName = this.querySelector('h3').textContent;
        console.log(`Feature clicked: ${featureName}`);
        // Future: Navigate to feature detail page or open modal
    });
});

// Initialize everything when DOM is fully loaded
document.addEventListener('DOMContentLoaded', () => {
    console.log('Bijoy 24 Hall Management System initialized successfully!');
